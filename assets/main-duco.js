...
importScripts("https://ryanfortner.github.io/Duinotize/hashers/hash-duco-s1.js")
importScripts("https://ryanfortner.github.io/Duinotize/hashers/hash-wasm.js")
                ...
                console.log(`${getTime()} | ` + "CPU" + workerVer + ": Debug info: " + username + " | " + wallet_id + " | " + difficulty + " | " + hasher + " | " + serverMessage);
                    ...
                    for (result = 0; result < 100 * miningDifficulty + 1; result++) {
                        ...
                        if (job[1] === hashresult) {
                            ...
                            socket.send(result + "," + hashrate + ",Duinotize v1.2," + rigid + ",," + wallet_id);
                            console.log("----------------------------------------");
                        }
                    }
                } else {
