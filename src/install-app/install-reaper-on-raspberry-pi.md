---
title: Install Reaper on Raspberry Pi | Pi-Apps
description: Install Reaper on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Reaper/icon-64.png" height=24> Reaper on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Reaper is very easy to install on your Raspberry Pi in just two steps.
...
Reaper will run on either PiOS 32-bit or 64-bit.
</div>
<div class="simple-install-content content">
