---
title: Install Disk Usage Analyzer on Raspberry Pi | Pi-Apps
description: Install Disk Usage Analyzer on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Disk Usage Analyzer/icon-64.png" height=24> Disk Usage Analyzer on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Disk Usage Analyzer is very easy to install on your Raspberry Pi in just two steps.
...
Disk Usage Analyzer will run on either PiOS 32-bit or 64-bit.
</div>
<div class="simple-install-content content">
