---
title: Install eDEX-UI on Linux ARM Device | Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/eDEX-UI/icon-64.png" height=24> eDEX-UI on Linux ARM Device
...
Fortunately, eDEX-UI is very easy to install on your Linux ARM Device in just two steps.
...
eDEX-UI will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
