---
title: Install SimpleScreenRecorder on Linux ARM Device | Pi-Apps
description: Install SimpleScreenRecorder on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/SimpleScreenRecorder/icon-64.png" height=24> SimpleScreenRecorder on Linux ARM Device
...
Fortunately, SimpleScreenRecorder is very easy to install on your Linux ARM Device in just two steps.
...
SimpleScreenRecorder will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
