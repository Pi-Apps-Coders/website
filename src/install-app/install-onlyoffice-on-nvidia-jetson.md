---
title: Install OnlyOffice on Nvidia Jetson | Pi-Apps
description: Install OnlyOffice on Nvidia Jetson using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/OnlyOffice/icon-64.png" height=24> OnlyOffice on <img src=/img/other-icons/nvidia-icon.svg height=24> Nvidia Jetson
...
Fortunately, OnlyOffice is very easy to install on your Nvidia Jetson in just two steps.
...
OnlyOffice will run on L4T Ubuntu ARM64.
</div>
<div class="simple-install-content content">
