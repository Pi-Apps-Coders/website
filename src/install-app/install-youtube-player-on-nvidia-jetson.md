---
title: Install YouTube Player on Nvidia Jetson | Pi-Apps
description: Install YouTube Player on Nvidia Jetson using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/YouTube Player/icon-64.png" height=24> YouTube Player on <img src=/img/other-icons/nvidia-icon.svg height=24> Nvidia Jetson
...
Fortunately, YouTube Player is very easy to install on your Nvidia Jetson in just two steps.
...
YouTube Player will run on L4T Ubuntu ARM64.
</div>
<div class="simple-install-content content">
