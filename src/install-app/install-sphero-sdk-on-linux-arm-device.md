---
title: Install Sphero SDK on Linux ARM Device | Pi-Apps
description: Install Sphero SDK on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Sphero SDK/icon-64.png" height=24> Sphero SDK on Linux ARM Device
...
Fortunately, Sphero SDK is very easy to install on your Linux ARM Device in just two steps.
...
Sphero SDK will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
