---
title: Install Synaptic on Linux ARM Device | Pi-Apps
description: Install Synaptic on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Synaptic/icon-64.png" height=24> Synaptic on Linux ARM Device
...
Fortunately, Synaptic is very easy to install on your Linux ARM Device in just two steps.
...
Synaptic will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
