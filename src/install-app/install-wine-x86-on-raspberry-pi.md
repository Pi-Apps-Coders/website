...
# Install <img src="/img/app-icons/Wine (x86)/icon-64.png" height=24> Wine (x86) on <img src=https://www.vectorlogo.zone/logos/raspberrypi/raspberrypi-icon.svg height=24> Raspberry Pi
