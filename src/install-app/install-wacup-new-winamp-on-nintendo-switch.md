---
title: Install WACUP (new WinAmp) on Nintendo Switch | Pi-Apps
description: Install WACUP (new WinAmp) on Nintendo Switch using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/WACUP (new WinAmp)/icon-64.png" height=24> WACUP (new WinAmp) on <img src=/img/other-icons/switch-icon.svg height=24> Nintendo Switch

## <img src="/img/app-icons/WACUP (new WinAmp)/icon-64.png"> WACUP (new WinAmp)
> Cross-platform audio player - emulated Windows app

Fortunately, WACUP (new WinAmp) is very easy to install on your Nintendo Switch in just two steps.
...
WACUP (new WinAmp) will run on L4T Ubuntu ARM64.
</div>
<div class="simple-install-content content">
