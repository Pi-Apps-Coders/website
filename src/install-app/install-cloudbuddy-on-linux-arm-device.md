---
title: Install CloudBuddy on Linux ARM Device | Pi-Apps
description: Install CloudBuddy on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/CloudBuddy/icon-64.png" height=24> CloudBuddy on Linux ARM Device
...
Fortunately, CloudBuddy is very easy to install on your Linux ARM Device in just two steps.
...
CloudBuddy will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
