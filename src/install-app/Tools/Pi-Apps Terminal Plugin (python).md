...
## Install <img src="/img/app-icons/Pi-Apps Terminal Plugin (python)/icon-64.png" height=24> ***[Pi-Apps Terminal Plugin (python)](/wiki/getting-started/apps-list/#pi-apps-terminal-plugin-(python))***
