...
## Install <img src="/img/app-icons/Pi-Apps Terminal Plugin (bash)/icon-64.png" height=24> ***[Pi-Apps Terminal Plugin (bash)](/wiki/getting-started/apps-list/#pi-apps-terminal-plugin-(bash))***
