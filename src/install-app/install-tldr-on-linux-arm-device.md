---
title: Install tldr on Linux ARM Device | Pi-Apps
description: Install tldr on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/tldr/icon-64.png" height=24> tldr on Linux ARM Device
...
Fortunately, tldr is very easy to install on your Linux ARM Device in just two steps.
...
tldr will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
