---
title: Install Botspot Virtual Machine on Linux ARM Device | Pi-Apps
description: Install Botspot Virtual Machine on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Botspot Virtual Machine/icon-64.png" height=24> Botspot Virtual Machine on Linux ARM Device
...
Fortunately, Botspot Virtual Machine is very easy to install on your Linux ARM Device in just two steps.
...
Botspot Virtual Machine will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install Botspot Virtual Machine on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
