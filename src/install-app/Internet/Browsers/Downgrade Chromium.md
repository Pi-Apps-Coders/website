...
## Install <img src="/img/app-icons/Downgrade Chromium/icon-64.png" height=24> ***[Downgrade Chromium](https://github.com/Botspot/pi-apps/tree/master/apps/Downgrade%20Chromium)***
Pi-Apps has a wonderful GUI to install apps from that you can read about [here](/wiki/getting-started/running-pi-apps/)
        
You may also use the terminal to install apps through Pi-Apps
```
~/pi-apps/manage install "Downgrade Chromium"
```
