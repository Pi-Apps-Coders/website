...
# Install <img src="/img/app-icons/Deluge/icon-64.png" height=24> Deluge on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Deluge is very easy to install on your Raspberry Pi in just two steps.
...
Deluge will run on either PiOS 32-bit or 64-bit.
</div>
<div class="simple-install-content content">
