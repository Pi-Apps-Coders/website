...
# Install <img src="/img/app-icons/Pac-Man/icon-64.png" height=24> Pac-Man on <img src=/img/other-icons/switchroot-icon.png height=24> Nintendo Switch
...
Now scroll down to find Pac-Man in the list.
