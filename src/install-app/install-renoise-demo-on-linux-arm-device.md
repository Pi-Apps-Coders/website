---
title: Install Renoise (Demo) on Linux ARM Device | Pi-Apps
description: Install Renoise (Demo) on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Renoise (Demo)/icon-64.png" height=24> Renoise (Demo) on Linux ARM Device
...
Renoise (Demo) will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install Renoise (Demo) on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
