---
title: Install Dot Matrix on Debian / Pi OS / Ubuntu (ARM64 ONLY) | Pi-Apps
---
# Install Pi-Apps and Dot Matrix on <img src=https://www.vectorlogo.zone/logos/debian/debian-icon.svg height=20 /> Debian / <img src=https://www.vectorlogo.zone/logos/raspberrypi/raspberrypi-icon.svg height=20 /> Pi OS / <img src=https://www.vectorlogo.zone/logos/ubuntu/ubuntu-icon.svg height=20 /> Ubuntu (ARM64 ONLY)
## Install Pi-Apps
...
## Install <img src="/img/app-icons/Dot Matrix/icon-64.png" height=24> ***[Dot Matrix](https://github.com/Botspot/pi-apps/tree/master/apps/Dot%20Matrix)***
Pi-Apps has a wonderful GUI to install apps from that you can read about [here](/wiki/getting-started/running-pi-apps/)
        
You may also use the terminal to install apps through Pi-Apps
```
~/pi-apps/manage install "Dot Matrix"
```
