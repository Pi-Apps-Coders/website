---
title: Install Caskaydia Cove NF on Linux ARM Device | Pi-Apps
description: Install Caskaydia Cove NF on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Caskaydia Cove NF/icon-64.png" height=24> Caskaydia Cove NF on Linux ARM Device
...
Fortunately, Caskaydia Cove NF is very easy to install on your Linux ARM Device in just two steps.
...
Caskaydia Cove NF will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
