---
title: Install Chrome on Linux ARM Device | Pi-Apps
description: Install Chrome on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Chrome/icon-64.png" height=24> Chrome on Linux ARM Device
...
Fortunately, Chrome is very easy to install on your Linux ARM Device in just two steps.
...
Chrome will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install Chrome on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
