---
title: Install Mission Center on Raspberry Pi | Pi-Apps
description: Install Mission Center on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Mission Center/icon-64.png" height=24> Mission Center on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
**Mission Center will only run on PiOS 64-bit.** Pi-Apps will not let you install Mission Center on PiOS 32-bit.
</div>
<div class="simple-install-content content">
