---
title: Install Gnome Builder IDE on Debian / Pi OS / Ubuntu (ARM64 ONLY) | Pi-Apps
---
# Install Pi-Apps and Gnome Builder IDE on <img src=https://www.vectorlogo.zone/logos/debian/debian-icon.svg height=20 /> Debian / <img src=https://www.vectorlogo.zone/logos/raspberrypi/raspberrypi-icon.svg height=20 /> Pi OS / <img src=https://www.vectorlogo.zone/logos/ubuntu/ubuntu-icon.svg height=20 /> Ubuntu (ARM64 ONLY)
## Install Pi-Apps
...
## Install <img src="/img/app-icons/Gnome Builder IDE/icon-64.png" height=24> ***[Gnome Builder IDE](/wiki/getting-started/apps-list/#gnome-builder-ide)***
