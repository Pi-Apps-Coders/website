---
title: Install Steam Link on Raspberry Pi | Pi-Apps
description: Install Steam Link on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Steam Link/icon-64.png" height=24> Steam Link on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Steam Link is very easy to install on your Raspberry Pi in just two steps.
...
Steam Link will run on either PiOS 32-bit or 64-bit.
</div>
<div class="simple-install-content content">
