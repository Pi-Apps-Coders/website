---
title: Install Descent 1 on Debian / Pi OS / Ubuntu (ARM32 ONLY) | Pi-Apps
---
# Install Pi-Apps and Descent 1 on <img src=https://www.vectorlogo.zone/logos/debian/debian-icon.svg height=20 /> Debian / <img src=https://www.vectorlogo.zone/logos/raspberrypi/raspberrypi-icon.svg height=20 /> Pi OS / <img src=https://www.vectorlogo.zone/logos/ubuntu/ubuntu-icon.svg height=20 /> Ubuntu (ARM32 ONLY)
## Install Pi-Apps
...
## Install <img src="/img/app-icons/Descent 1/icon-64.png" height=24> ***[Descent 1](/wiki/getting-started/apps-list/#descent-1)***
