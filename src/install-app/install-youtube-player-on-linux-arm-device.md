---
title: Install YouTube Player on Linux ARM Device | Pi-Apps
description: Install YouTube Player on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/YouTube Player/icon-64.png" height=24> YouTube Player on Linux ARM Device

## <img src="/img/app-icons/YouTube Player/icon-64.png"> YouTube Player
...
Fortunately, YouTube Player is very easy to install on your Linux ARM Device in just two steps.
...
YouTube Player will only run on an Ubuntu/Debian ARM64 OS. Pi-Apps will not let you install YouTube Player on an Ubuntu/Debian ARM32 OS.
</div>
<div class="simple-install-content content">
...
Now scroll down to find <b>YouTube Player</b> in the list.
<img src="/img/app-icons/YouTube Player/app-selection.png">
