---
title: Install Antigravity on Raspberry Pi | Pi-Apps
description: Install Antigravity on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Antigravity/icon-64.png" height=24> Antigravity on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Antigravity is very easy to install on your Raspberry Pi in just two steps.
...
**Antigravity will only run on PiOS 64-bit.** Pi-Apps will not let you install Antigravity on PiOS 32-bit.
</div>
<div class="simple-install-content content">
