---
title: Install WACUP (new WinAmp) on Linux ARM Device | Pi-Apps
description: Install WACUP (new WinAmp) on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/WACUP (new WinAmp)/icon-64.png" height=24> WACUP (new WinAmp) on Linux ARM Device

## <img src="/img/app-icons/WACUP (new WinAmp)/icon-64.png"> WACUP (new WinAmp)
> Cross-platform audio player - emulated Windows app

Fortunately, WACUP (new WinAmp) is very easy to install on your Linux ARM Device in just two steps.
