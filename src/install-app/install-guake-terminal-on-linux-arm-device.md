---
title: Install Guake Terminal on Linux ARM Device | Pi-Apps
description: Install Guake Terminal on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Guake Terminal/icon-64.png" height=24> Guake Terminal on Linux ARM Device
...
Fortunately, Guake Terminal is very easy to install on your Linux ARM Device in just two steps.
...
Guake Terminal will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
