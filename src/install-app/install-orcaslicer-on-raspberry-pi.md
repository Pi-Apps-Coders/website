---
title: Install OrcaSlicer on Raspberry Pi | Pi-Apps
description: Install OrcaSlicer on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/OrcaSlicer/icon-64.png" height=24> OrcaSlicer on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, OrcaSlicer is very easy to install on your Raspberry Pi in just two steps.
...
**OrcaSlicer will only run on PiOS 64-bit.** Pi-Apps will not let you install OrcaSlicer on PiOS 32-bit.
</div>
<div class="simple-install-content content">
