---
title: Install Cura on Linux ARM Device | Pi-Apps
description: Install Cura on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Cura/icon-64.png" height=24> Cura on Linux ARM Device
...
Fortunately, Cura is very easy to install on your Linux ARM Device in just two steps.
...
Cura will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
