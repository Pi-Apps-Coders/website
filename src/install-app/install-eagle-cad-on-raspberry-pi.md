...
# Install <img src="/img/app-icons/Eagle CAD/icon-64.png" height=24> Eagle CAD on <img src=https://www.vectorlogo.zone/logos/raspberrypi/raspberrypi-icon.svg height=24> Raspberry Pi
...
Eagle CAD will only run on PiOS 32-bit. Pi-Apps will not let you install Eagle CAD on PiOS 64-bit.
</div>
<div class="simple-install-content content">
