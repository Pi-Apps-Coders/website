---
title: Install Powerline-Shell on Linux ARM Device | Pi-Apps
description: Install Powerline-Shell on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Powerline-Shell/icon-64.png" height=24> Powerline-Shell on Linux ARM Device
...
Fortunately, Powerline-Shell is very easy to install on your Linux ARM Device in just two steps.
...
Powerline-Shell will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
