---
title: Install Project OutFox on Linux ARM Device | Pi-Apps
description: Install Project OutFox on Linux ARM Device using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Project OutFox/icon-64.png" height=24> Project OutFox on Linux ARM Device
...
Fortunately, Project OutFox is very easy to install on your Linux ARM Device in just two steps.
...
Project OutFox will run on either an Ubuntu/Debian ARM32 OS or ARM64 OS.
</div>
<div class="simple-install-content content">
