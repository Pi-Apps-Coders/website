---
title: Install Quartz on Nintendo Switch | Pi-Apps
description: Install Quartz on Nintendo Switch using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Quartz/icon-64.png" height=24> Quartz on <img src=/img/other-icons/switch-icon.svg height=24> Nintendo Switch
...
Fortunately, Quartz is very easy to install on your Nintendo Switch in just two steps.
