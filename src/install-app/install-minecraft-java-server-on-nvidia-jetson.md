...
# Install <img src="/img/app-icons/Minecraft Java Server/icon-64.png" height=24> Minecraft Java Server on <img src=https://assets.nvidiagrid.net/favicon.ico height=24> Nvidia Jetson
...
Fortunately, Minecraft Java Server is very easy to install on your Nvidia Jetson in just two steps.
