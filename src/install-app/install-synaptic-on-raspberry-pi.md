---
title: Install Synaptic on Raspberry Pi | Pi-Apps
description: Install Synaptic on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Synaptic/icon-64.png" height=24> Synaptic on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Synaptic is very easy to install on your Raspberry Pi in just two steps.
...
Synaptic will run on either PiOS 32-bit or 64-bit.
</div>
<div class="simple-install-content content">
