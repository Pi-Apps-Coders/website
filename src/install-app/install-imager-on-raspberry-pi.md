---
title: Install Imager on Raspberry Pi | Pi-Apps
description: Install Imager on Raspberry Pi using Pi-Apps
---
<div class="simple-install-content content">

# Install <img src="/img/app-icons/Imager/icon-64.png" height=24> Imager on <img src=/img/other-icons/raspberrypi-icon.svg height=24> Raspberry Pi
...
Fortunately, Imager is very easy to install on your Raspberry Pi in just two steps.
...
Imager will run on either PiOS 32-bit or 64-bit.
</div>
<div class="simple-install-content content">
