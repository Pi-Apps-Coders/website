...
- <img src="/img/other-icons/ubuntu-icon.svg" height="14"> [**Ubuntu**](https://ubuntu.com/download/raspberry-pi) (Jammy/22.04 LTS) (GNOME, Mate, KDE, Budgie, etc): <span style="color:var(--success-dark);">fully supported</span>
...
- <img src="/img/other-icons/ubuntu-icon.svg" height="14"> [Ubuntu Focal 20.04/Jammy 22.04](https://ubuntu.com/download/desktop) (Official Releases from Canonical **ONLY**): <span style="color:var(--warn-dark);">Not actively tested but all available apps should work</span>
